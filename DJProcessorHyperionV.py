...
for ctr in range(25):
    ...
    try:
        ...
        outstr2 = 'C:\\Users\\mysti\\Coding\\Fractalizer\\Sample_Export\\'+ tim + "_"  + str(ctr) + '_FullBeatLoopForBeatTrack_' + str(ctr) + ".wav"

        #if int(os.stat(newAudiog).st_size) < sizlim:
        newAudiopp.export(oufil, format="wav")
        newAudiopp.export(outstr2, format="wav")

        outstr2 = 'C:\\Users\\mysti\\Coding\\Fractalizer\\Sample_Export\\' + tim + "_" + str(ctr) + '_BeatSampleForBeatTrack_' + str(ctr) + ".wav"
        shutil.copy(atrack, outstr2)

        outstr3 = 'C:\\Users\\mysti\\Coding\\Fractalizer\\Sample_Export\\'+ tim + "_"  + str(ctr) + '_BassSampleForBeatTrack_' + str(ctr) + ".wav"
        shutil.copy(btrack, outstr3)

        outstra = 'C:\\Users\\mysti\\Coding\\Fractalizer\\Sample_Export\\'+ tim + "_"  + str(ctr) + '_OrganSampleForBeatTrack_' + str(ctr) + ".wav"
        shutil.copy(ctrack, outstra)

        outstrb = 'C:\\Users\\mysti\\Coding\\Fractalizer\\Sample_Export\\' + tim + "_" + str(ctr) + '_OrganSampleForBeatTrack_' + str(ctr) + ".wav"
        shutil.copy(ctrack2, outstrb)

        outstrc = 'C:\\Users\\mysti\\Coding\\Fractalizer\\Sample_Export\\'+ tim + "_"  + str(ctr) + '_StabSampleForBeatTrack_' + str(ctr) + ".wav"
        shutil.copy(dtrack, outstrc)
        
        outstrd = 'C:\\Users\\mysti\\Coding\\Fractalizer\\Sample_Export\\' + tim + "_" + str(ctr) + '_Perc1SampleForBeatTrack_' + str(ctr) + ".wav"
        shutil.copy(etrack, outstrd)

        outstre = 'C:\\Users\\mysti\\Coding\\Fractalizer\\Sample_Export\\' + tim + "_" + str(ctr) + '_Perc2SampleForBeatTrack_' + str(ctr) + ".wav"
        shutil.copy(etrack2, outstre)

        outstrf = 'C:\\Users\\mysti\\Coding\\Fractalizer\\Sample_Export\\'+ tim + "_"  + str(ctr) + '_Perc3SampleForBeatTrack_' + str(ctr) + ".wav"
        shutil.copy(ftrack, outstrf)

        outstrg = 'C:\\Users\\mysti\\Coding\\Fractalizer\\Sample_Export\\' + tim + "_" + str(ctr) + '_Perc4SampleForBeatTrack_' + str(ctr) + ".wav"
        shutil.copy(ftrack2, outstrg)
...
call(["python", "NuDubberHyperionV.py"])
