...
for ctr in range(700):
    ...
    try:
        ...
        newAudionear3= newAudioamb2 * 6

        #ewAudiobeat = AudioSegment.from_wav(atrack1) 
        ...
        oufil = "C:\\Users\\mysti\\Desktop\\AutoProd\\Raw\\Mastered_Atmos" + tim + "." + str(suctot) + ".wav"
...
call(["python", "C:\\Users\\mysti\\Coding\\Fractalizer\\BatchDeleterAmb.py"])
