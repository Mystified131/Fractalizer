...
try:
    ...
    newpath = "C:\\Users\\mysti\\Desktop\\Newalbum"
...
for ctr in range(trtot):
    ...
    oufil =  "C:\\Users\\mysti\\Desktop\\Newalbum\\Track" + tim + "_" + str(ctr) + ".wav"
...
call(["python", "C:\\Users\\mysti\\Coding\\Fractalizer\\JustAudioAddFileRenamerb.py"])
