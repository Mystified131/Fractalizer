...
for subdir, dirs, files in os.walk(srchstr):
    for file in files:
        ...
        if  filepath.endswith(".wav") and (("Drone" in str(filepath)) or ("Pad" in str(filepath)) ) and ("Chillout" in str(filepath) and (("Drum" not in str(filepath)) and ("Beat" not in str(filepath)) and ("Bass" not in str(filepath))) ):

            contentdrones.append(filepath)

        if  filepath.endswith(".wav") and ("Key" in str(filepath)) and  ("Chillout" in str(filepath) and (("Drum" not in str(filepath)) and ("Beat" not in str(filepath)) and ("Bass" not in str(filepath))) ): 

            contentsax.append(filepath) 

        if  filepath.endswith(".wav") and ("Noise" in str(filepath) and (("Drum" not in str(filepath)) and ("Beat" not in str(filepath)) and ("Bass" not in str(filepath))) ):

            contentpepper.append(filepath)

        if  filepath.endswith(".wav") and ("Gui" in str(filepath)) and ("Rock" in str(filepath)) and (("Drum" not in str(filepath)) and ("Beat" not in str(filepath)) and ("Bass" not in str(filepath))) :

            contentgit.append(filepath)

        if  filepath.endswith(".wav") and ("Syn" in str(filepath))and ("Chillout" in str(filepath)) and (("Drum" not in str(filepath)) and ("Beat" not in str(filepath)) and ("Bass" not in str(filepath)))  :

            contentorg.append(filepath) 

        if  filepath.endswith(".wav") and ("Perc" in str(filepath)) and ("Rock" in str(filepath)) and (("Drum" not in str(filepath)) and ("Beat" not in str(filepath)) and ("Bass" not in str(filepath)))  :

            contentperc.append(filepath)

        if  filepath.endswith(".wav") and ("Bass" in str(filepath)) and ("Upright" in str(filepath)) and (("Drum" not in str(filepath)) and ("Beat" not in str(filepath)))  :

            contentbass.append(filepath)   

        if  filepath.endswith(".wav")  and ("Beat" in str(filepath)) and ("Rock" in str(filepath)) and  ("Bass" not in str(filepath)) :
