...
for ctr in range(700):
    ...
    try:
        ...
        oufild = "C:\\Users\\mysti\\Coding\\Fractalizer\\Sample_Export\\" + tim + "." + str(suctot) + ".wav"
        newAudiomag.export(oufil, format="wav")
        newAudiomag.export(oufild, format="wav")

        outstrc = 'C:\\Users\\mysti\\Coding\\Fractalizer\\Sample_Export\\'+ tim + "_"  + str(ctr) + '_FullAmbLoopForMastTrack_' + str(ctr) + ".wav"

        newAudiow2.export(outstrc, format="wav")
...
for subdir, dirs, files in os.walk('C:\\Users\\mysti\\Coding\\Fractalizer'):
    for file in files:
        ...
        if ((filepath.endswith(".ogg")) or (filepath.endswith(".wav")) or (filepath.endswith(".txt")) or (filepath.endswith(".sfk"))) and ("Export" not in str(filepath)) :
            os. remove(filepath) 
...
call(["python", "C:\\Users\\mysti\\Coding\\Fractalizer\\HyperionVStartProc.py"])
