...
for subdir, dirs, files in os.walk(srchstr):
    for file in files:
        ...
        if  filepath.endswith(".wav")  and (("Eth" in str(filepath)) or ("Wor" in str(filepath)) or ("Indian" in str(filepath)) or ("Boll" in str(filepath)))  and ("ZZ Indie" not in str(filepath)): 
        ...
        if  filepath.endswith(".wav")  and (("Beat" in str(filepath)) or ("Drum" in str(filepath)))  and ("Drum&Bass" in str(filepath)) : 

            contentbeats.append(filepath)

        if  filepath.endswith(".wav")  and("Bass" in str(filepath)) and  ("Wor" in str(filepath)) and ("Step"  not in str(filepath)) : 
