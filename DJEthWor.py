...
for subdir, dirs, files in os.walk(srchstr):
    for file in files:
        ...
        if  filepath.endswith(".wav")  and (("Eth" in str(filepath)) or ("Wor" in str(filepath)) or ("Ind" in str(filepath)) or ("Boll" in str(filepath)))  and ("ZZ Indie" not in str(filepath)): 
        ...
        if  filepath.endswith(".wav")  and ("Perc" in str(filepath))  and (("Eth" in str(filepath)) or ("Wor" in str(filepath))) : 

            contentperc.append(filepath)

        if  filepath.endswith(".wav")  and (("Beat" in str(filepath)) or ("Drum" in str(filepath)))  and (("Eth" in str(filepath)) or ("Wor" in str(filepath))  or ("Eno" in str(filepath))) : 

            contentbeats.append(filepath)

        if  filepath.endswith(".wav")  and("Bass" in str(filepath)) and  (("Eth" in str(filepath)) or ("Wor" in str(filepath)) or ("Eno" in str(filepath)))and ("Step"  not in str(filepath)) : 
