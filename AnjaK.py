...
for subdir, dirs, files in os.walk(srchstr):
    for file in files:
        ...
        if  filepath.endswith(".wav")  and (("Drum" in str(filepath)) and ("Bass" in str(filepath))  or ("Glitch" in str(filepath)))  and ("ZZ Indie" not in str(filepath)): 
        ...
        if  filepath.endswith(".wav")  and  ("AnjaK" in str(filepath)): 
               
            contentdrones.append(filepath)

            contentorg.append(filepath)

        if  filepath.endswith(".wav")  and ("Elec" in str(filepath)) : 
