...
for subdir, dirs, files in os.walk(srchstr):
    for file in files:
        ...
        if  filepath.endswith(".wav")  and ("Elect" in str(filepath))  and ("ZZ Indie" not in str(filepath)): 
        ...
        if  filepath.endswith(".wav")  and ("Brainquake" in str(filepath)) : 

            contentperc.append(filepath)

        if  filepath.endswith(".wav")  and (("Beat" in str(filepath)) or ("Drum" in str(filepath)))  and ("Elect" in str(filepath))  : 
