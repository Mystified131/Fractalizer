...
for subdir, dirs, files in os.walk(srchstr):
    for file in files:
        ...
        if  filepath.endswith(".wav")  and ("Rhod" in str(filepath)): 

            contentdrones.append(filepath)

            contentorg.append(filepath) 

        if  filepath.endswith(".wav")  and   ("Viol" in str(filepath)) :
        ...
        if  filepath.endswith(".wav")  and  ("Wood" in str(filepath)  and  "Perc" in str(filepath)):
            contentperc.append(filepath)

        if  filepath.endswith(".wav")  and  ("Lat" in str(filepath))  and  (("Beat" in str(filepath)) or ("Drum" in str(filepath))) :     

            contentbeats.append(filepath)

        if  filepath.endswith(".wav")  and  ("Acoust" in str(filepath)) and  ("Bass" in str(filepath)):
...
call(["python", "DJProcessorHyperionV.py"])
