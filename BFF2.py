...
for subdir, dirs, files in os.walk(srchstr):
    for file in files:
        ...
        if  filepath.endswith(".wav")  and ("Ambi" in str(filepath)) or ("Score" in str(filepath))  and ("ZZ Indie" not in str(filepath)): 
        ...
        if  filepath.endswith(".wav")  and ("Perc" in str(filepath))  and (("Tech" in str(filepath)) or ("Wor" in str(filepath))) : 

            contentperc.append(filepath)

        if  filepath.endswith(".wav")  and (("Beat" in str(filepath)) or ("Drum" in str(filepath)))  and ("Acoustic" in str(filepath)) : 
